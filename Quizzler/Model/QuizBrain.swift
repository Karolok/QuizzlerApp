...
struct QuizBrain {
    ...
    func getQuestionLabelText() -> String {
        return quiz[questionNumber].name
    }
    
    func getFirstButtonLabelText() -> String {
          return quiz[questionNumber].answers[0]
    }
    
    func getSecondButtonLabelText() -> String {
          return quiz[questionNumber].answers[1]
    }
    
    func getThirdButtonLabelText() -> String {
    ...
    func checkIsWin() -> Bool {
        if(score == quiz.count) { return true }
        else { return false }
    }
}
